...
/// App-specific colors for EMSCodeSim Vitals.
///
/// These are layered on top of the Material `ColorScheme` to support
/// custom gradients and semantic accents.
class AppColors {
  static const Color emsCyan = Color(0xFF1EC8E7);
  static const Color emsBlue = Color(0xFF1A6BFF);
  static const List<Color> headerGradient = [emsBlue, emsCyan];

  static const Color brady = Color(0xFF2563EB); // blue
  static const Color tachy = Color(0xFFF97316); // orange

  static const Color danger = Color(0xFFE5484D);
  static const Color dangerOn = Color(0xFFFFFFFF);

  static const Color gaugeNeedle = Color(0xFFE5484D);
  static const Color gaugeMetalDark = Color(0xFF6B7280);
  static const Color gaugeMetalLight = Color(0xFFE5E7EB);
}
